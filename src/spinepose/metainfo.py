metainfo = dict(
    ...
    keypoint_info={
        ...
        26: dict(name="spine_01", id=26, color=[51, 153, 255], type="upper", swap=""),
        27: dict(name="spine_02", id=27, color=[51, 153, 255], type="upper", swap=""),
        28: dict(name="spine_03", id=28, color=[51, 153, 255], type="upper", swap=""),
        29: dict(name="spine_04", id=29, color=[51, 153, 255], type="upper", swap=""),
        30: dict(name="spine_05", id=30, color=[51, 153, 255], type="upper", swap=""),
        31: dict(name="left_latissimus", id=31, color=[0, 255, 0], type="upper", swap="right_latissimus"),
        32: dict(name="right_latissimus", id=32, color=[255, 128, 0], type="upper", swap="left_latissimus"),
        33: dict(name="left_clavicle", id=33, color=[0, 255, 0], type="upper", swap="right_clavicle"),
        34: dict(name="right_clavicle", id=34, color=[255, 128, 0], type="upper", swap="left_clavicle"),
        35: dict(name="neck_02", id=35, color=[51, 153, 255], type="upper", swap=""),
        36: dict(name="neck_03", id=36, color=[51, 153, 255], type="upper", swap=""),
    },
    skeleton_info={
